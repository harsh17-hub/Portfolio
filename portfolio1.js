...
document.addEventListener("DOMContentLoaded", () => {
    ...
    lightButton.style.bottom = "100px";

    lightButton.style.right = "30px";

    lightButton.style.width = "55px";

    lightButton.style.height = "55px";

    lightButton.style.borderRadius = "50%";

    lightButton.style.background = "linear-gradient(135deg, var(--primary), var(--secondary))";
    ...
    lightButton.style.zIndex = "999";

    document.body.appendChild(lightButton);

    lightButton.addEventListener("click", () => {
        
        if (lightButton.textContent === "☀️") {
